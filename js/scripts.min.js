if (function(t, e) {
    ...
    function s() {
        nt.addEventListener ? (nt.removeEventListener("DOMContentLoaded", a),
        t.removeEventListener("load", a)) : (nt.detachEvent("onreadystatechange", a),
        t.detachEvent("onload", a))
    }
    function a() {
        (nt.addEventListener || "load" === t.event.type || "complete" === nt.readyState) && (s(),
        ht.ready())
    }
    function l(t, e, n) {
    ...
    function u(t, e, n, i) {
        if (At(t)) {
            ...
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof e)
                return c || (c = a ? t[s] = et.pop() || ht.guid++ : s),
                l[c] || (l[c] = a ? {} : {
                    toJSON: ht.noop
                }),
                ...
                "string" == typeof e ? null == (o = r[e]) && (o = r[ht.camelCase(e)]) : o = r,
                o
        }
    }
    function d(t, e, n) {
        if (At(t)) {
            ...
            if (s[a]) {
                ...
                (n || (delete s[a].data,
                c(s[a]))) && (r ? ht.cleanData([t], !0) : ut.deleteExpando || s != s.window ? delete s[a] : s[a] = void 0)
            }
        }
    }
    function h(t, e, n, i) {
    ...
    function v(t, e, n, i, o) {
        for (var r, s, a, l, c, u, d, h = t.length, v = p(e), y = [], w = 0; h > w; w++)
            if ((s = t[w]) || 0 === s)
                if ("object" === ht.type(s))
                    ...
                    c = (Ht.exec(s) || ["", ""])[1].toLowerCase(),
                    d = Ft[c] || Ft._default,
                    l.innerHTML = d[1] + ht.htmlPrefilter(s) + d[2],
                    r = d[0]; r--; )
                        l = l.lastChild;
                    if (!ut.leadingWhitespace && Rt.test(s) && y.push(e.createTextNode(Rt.exec(s)[0])),
                    !ut.tbody)
                        for (r = (s = "table" !== c || Ut.test(s) ? "<table>" !== d[1] || Ut.test(s) ? 0 : l : l.firstChild) && s.childNodes.length; r--; )
        ...
        ut.appendChecked || ht.grep(f(y, "input"), m),
        w = 0; s = y[w++]; )
    ...
    function E(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            ut.html5Clone && t.innerHTML && !ht.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && zt.test(t.type) ? (e.defaultChecked = e.checked = t.checked,
    ...
    function k(t, e, n, i) {
        e = ot.apply([], e);
        var o, r, s, a, l, c, u = 0, d = t.length, h = d - 1, p = e[0], g = ht.isFunction(p);
        ...
        if (d && (c = v(e, t[0].ownerDocument, !1, t, i),
        o = c.firstChild,
        1 === c.childNodes.length && (c = o),
        o || i)) {
            for (s = (a = ht.map(f(c, "script"), T)).length; d > u; u++)
                r = c,
                u !== h && (r = ht.clone(r, !0, !0),
            ...
            if (s)
                ...
                u = 0; s > u; u++)
                    r = a[u],
                    Wt.test(r.type || "") && !ht._data(r, "globalEval") && ht.contains(l, r) && (r.src ? ht._evalUrl && ht._evalUrl(r.src) : ht.globalEval((r.text || r.textContent || r.innerHTML || "").replace(ie, "")));
            c = o = null
        }
        return t
    }
    ...
    function A(t) {
        var e = nt
          , n = se[t];
        return n || ("none" !== (n = N(t, e)) && n || (re = (re || ht("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement),
        (e = (re[0].contentWindow || re[0].contentDocument).document).write(),
        e.close(),
        n = N(t, e),
        re.detach()),
        se[t] = n),
    ...
    function D(t, e) {
        for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)
            (i = t[s]).style && (r[s] = ht._data(i, "olddisplay"),
            n = i.style.display,
            e ? (r[s] || "none" !== n || (i.style.display = ""),
            "" === i.style.display && Mt(i) && (r[s] = ht._data(i, "olddisplay", A(i.nodeName)))) : (o = Mt(i),
    ...
    function L(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)
            "margin" === n && (s += ht.css(t, n + Lt[r], !0, o)),
            i ? ("content" === n && (s -= ht.css(t, "padding" + Lt[r], !0, o)),
            "margin" !== n && (s -= ht.css(t, "border" + Lt[r] + "Width", !0, o))) : (s += ht.css(t, "padding" + Lt[r], !0, o),
            "padding" !== n && (s += ht.css(t, "border" + Lt[r] + "Width", !0, o)));
        return s
    }
    function M(t, e, n) {
        var i = !0
        ...
        if (0 >= o || null == o) {
            if ((0 > (o = he(t, e, r)) || null == o) && (o = t.style[e]),
            le.test(o))
                return o;
    ...
    function q(t, e, n) {
        var i, o, r = 0, s = q.prefilters.length, a = ht.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (o)
                return !1;
            for (var e = Ce || z(), n = Math.max(0, c.startTime + c.duration - e), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; s > r; r++)
                c.tweens[r].run(i);
            return a.notifyWith(t, [c, i, n]),
            1 > i && s ? n : (a.resolveWith(t, [c]),
            !1)
        }, c = a.promise({
            elem: t,
            props: ht.extend({}, e),
    ...
    function G(t) {
        if (!ht.contains(t.ownerDocument || nt, t))
            return !0;
        for (; t && 1 === t.nodeType; ) {
    ...
    ht.extend({
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (n(Object(t)) ? ht.merge(i, "string" == typeof t ? [t] : t) : rt.call(i, t)),
            i
        },
        ...
        proxy: function(t, e) {
            ...
            e = t,
            t = o),
            ht.isFunction(t) ? (n = it.call(arguments, 2),
            i = function() {
    ...
    var vt = function(t) {
        function e(t, e, n, i) {
            var o, r, s, a, c, d, h, p, f = e && e.ownerDocument, g = e ? e.nodeType : 9;
            if (n = n || [],
            "string" != typeof t || !t || 1 !== g && 9 !== g && 11 !== g)
                return n;
            if (!i && ((e ? e.ownerDocument || e : z) !== A && N(e),
            e = e || A,
            O)) {
                if (11 !== g && (d = gt.exec(t)))
                    if (o = d[1]) {
                        ...
                        if (d[2])
                            ...
                            n;
                        if ((o = d[3]) && w.getElementsByClassName && e.getElementsByClassName)
                ...
                if (w.qsa && !F[t + " "] && (!D || !D.test(t))) {
                    if (1 !== g)
                        ...
                        for ((a = e.getAttribute("id")) ? a = a.replace(vt, "\\$&") : e.setAttribute("id", a = j),
                        r = (h = T(t)).length,
                        c = ut.test(a) ? "#" + a : "[id='" + a + "']"; r--; )
                            h[r] = c + " " + u(h[r]);
                        p = h.join(","),
        ...
        function g(t, e, n, o, r, s) {
            ...
            r && !r[j] && (r = g(r, s)),
            i(function(i, s, a, l) {
                var c, u, d, h = [], g = [], m = s.length, v = i || p(e || "*", a.nodeType ? [a] : a, []), y = !t || !i && e ? v : f(v, h, t, a, l), w = n ? r || (i ? t : m || o) ? [] : s : y;
                if (n && n(y, w, a, l),
                o)
                    for (c = f(w, g),
                    o(c, [], a, l),
                ...
                if (i) {
                    if (r || t) {
                        ...
                        for (u = w.length; u--; )
                            (d = w[u]) && (c = r ? K(i, d) : h[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else
                    w = f(w === s ? w.splice(m, w.length) : w),
        ...
        function v(t, n) {
            var o = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, d, h, p = 0, g = "0", m = i && [], v = [], y = E, w = i || r && b.find.TAG("*", c), x = H += null == y ? 1 : Math.random() || .1, C = w.length;
                for (c && (E = s === A || s || c); g !== C && null != (u = w[g]); g++) {
                    if (r && u) {
                        for (d = 0,
                        s || u.ownerDocument === A || (N(u),
                        a = !O); h = t[d++]; )
                            if (h(u, s || A, a)) {
                                l.push(u);
                                break
        ...
        var y, w, b, x, C, T, S, _, E, k, $, N, A, I, O, D, P, L, M, j = "sizzle" + 1 * new Date, z = t.document, H = 0, W = 0, R = n(), q = n(), F = n(), B = function(t, e) {
            return t === e && ($ = !0),
            0
        }, U = 1 << 31, X = {}.hasOwnProperty, Q = [], V = Q.pop, Y = Q.push, G = Q.push, Z = Q.slice, K = function(t, e) {
            for (var n = 0, i = t.length; i > n; n++)
                if (t[n] === e)
                    return n;
            return -1
        }, J = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", tt = "[\\x20\\t\\r\\n\\f]", et = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", nt = "\\[" + tt + "*(" + et + ")(?:" + tt + "*([*^$|!~]?=)" + tt + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + et + "))|)" + tt + "*\\]", it = ":(" + et + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + nt + ")*)|.*)\\)|)", ot = new RegExp(tt + "+","g"), rt = new RegExp("^" + tt + "+|((?:^|[^\\\\])(?:\\\\.)*)" + tt + "+$","g"), st = new RegExp("^" + tt + "*," + tt + "*"), at = new RegExp("^" + tt + "*([>+~]|" + tt + ")" + tt + "*"), lt = new RegExp("=" + tt + "*([^\\]'\"]*?)" + tt + "*\\]","g"), ct = new RegExp(it), ut = new RegExp("^" + et + "$"), dt = {
            ID: new RegExp("^#(" + et + ")"),
            CLASS: new RegExp("^\\.(" + et + ")"),
            TAG: new RegExp("^(" + et + "|[*])"),
            ATTR: new RegExp("^" + nt),
        ...
        }, ht = /^(?:input|select|textarea|button)$/i, pt = /^h\d$/i, ft = /^[^{]+\{\s*\[native \w/, gt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, mt = /[+~]/, vt = /'|\\/g, yt = new RegExp("\\\\([\\da-f]{1,6}" + tt + "?|(" + tt + ")|.)","ig"), wt = function(t, e, n) {
            var i = "0x" + e - 65536;
        ...
        try {
            G.apply(Q = Z.call(z.childNodes), z.childNodes),
        ...
        N = e.setDocument = function(t) {
            ...
            I = A.documentElement,
            O = !C(A),
            (n = A.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", bt, !1) : n.attachEvent && n.attachEvent("onunload", bt)),
            ...
            P = [],
            D = [],
            (w.qsa = ft.test(A.querySelectorAll)) && (o(function(t) {
            ...
            e = ft.test(I.compareDocumentPosition),
            M = e || ft.test(I.contains) ? function(t, e) {
            ...
            : function(t, e) {
                ...
                if (!o || !r)
                    return t === A ? -1 : e === A ? 1 : o ? -1 : r ? 1 : k ? K(k, t) - K(k, e) : 0;
                if (o === r)
                    return s(t, e);
        ...
        e.matchesSelector = function(t, n) {
            if ((t.ownerDocument || t) !== A && N(t),
            n = n.replace(lt, "='$1']"),
            w.matchesSelector && O && !F[n + " "] && (!P || !P.test(n)) && (!D || !D.test(n)))
                try {
                    var i = L.call(t, n);
        ...
        e.uniqueSort = function(t) {
            var e, n = [], i = 0, o = 0;
            if ($ = !w.detectDuplicates,
            k = !w.sortStable && t.slice(0),
            t.sort(B),
            $) {
                for (; e = t[o++]; )
                    e === t[o] && (i = n.push(o));
        ...
        (b = e.selectors = {
            ...
            filter: {
                ...
                CHILD: function(t, e, n, i, o) {
                    ...
                    : function(e, n, l) {
                        var c, u, d, h, p, f, g = r !== s ? "nextSibling" : "previousSibling", m = e.parentNode, v = a && e.nodeName.toLowerCase(), y = !l && !a, w = !1;
                        if (m) {
                            if (r) {
                                for (; g; ) {
                                    for (h = e; h = h[g]; )
                            ...
                            s && y) {
                                for (w = (p = (c = (u = (d = (h = m)[j] || (h[j] = {}))[h.uniqueID] || (d[h.uniqueID] = {}))[t] || [])[0] === H && c[1]) && c[2],
                            ...
                            w = p),
                            !1 === w)
                                for (; (h = ++p && h && h[g] || (w = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++w || (y && (d = h[j] || (h[j] = {}),
                                u = d[h.uniqueID] || (d[h.uniqueID] = {}),
                                u[t] = [H, w]),
                                h !== e)); )
                                    ;
                ...
                PSEUDO: function(t, n) {
                    ...
                    return r[j] ? r(n) : r.length > 1 ? (o = [t, t, "", n],
        ...
        _ = e.select = function(t, e, n, i) {
            var o, r, s, a, c, d = "function" == typeof t && t, h = !i && T(t = d.selector || t);
            if (n = n || [],
            1 === h.length) {
                if ((r = h[0] = h[0].slice(0)).length > 2 && "ID" === (s = r[0]).type && w.getById && 9 === e.nodeType && O && b.relative[r[1].type]) {
                    if (!(e = (b.find.ID(s.matches[0].replace(yt, wt), e) || [])[0]))
                        return n;
                    d && (e = e.parentNode),
            ...
            return (d || S(t, h))(i, e, !O, n, !e || mt.test(t) && l(e.parentNode) || e),
            n
        }
        ,
        w.sortStable = j.split("").sort(B).join("") === j,
        w.detectDuplicates = !!$,
        N(),
    ...
    (ht.fn.init = function(t, e, n) {
        ...
        this.length = 1,
        this) : ht.isFunction(t) ? void 0 !== n.ready ? n.ready(t) : t(ht) : (void 0 !== t.selector && (this.selector = t.selector,
    ...
    ht.extend({
        ...
        when: function(t) {
            var e, n, i, o = 0, r = it.call(arguments), s = r.length, a = 1 !== s || t && ht.isFunction(t.promise) ? s : 0, l = 1 === a ? t : ht.Deferred(), c = function(t, n, i) {
                return function(o) {
                    n[t] = this,
    ...
    ht.extend({
        ...
        ready: function(t) {
            ...
            !0 !== t && --ht.readyWait > 0 || ($t.resolveWith(nt, [ht]),
            ht.fn.triggerHandler && (ht(nt).triggerHandler("ready"),
            ht(nt).off("ready"))))
        }
    }),
    ...
    ht(function() {
        var t, e, n, i;
        (n = nt.getElementsByTagName("body")[0]) && n.style && (e = nt.createElement("div"),
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                ...
                1 === r.nodeType && !ht._data(r, "parsedAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = ht.camelCase(i.slice(5)),
                        l(r, i, o[i]));
    ...
    ht.fn.extend({
        ...
        promise: function(t, e) {
            ...
            t = void 0),
            t = t || "fx"; s--; )
                (n = ht._data(r[s], t + "queueHooks")) && n.empty && (i++,
                n.empty.add(a));
            return a(),
            o.promise(e)
        }
    ...
    function() {
        ...
        ut.shrinkWrapBlocks = function() {
            ...
            t = !1;
            var e, n, i;
            return (n = nt.getElementsByTagName("body")[0]) && n.style ? (e = nt.createElement("div"),
            i = nt.createElement("div"),
            i.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px",
            n.appendChild(i).appendChild(e),
    ...
    !function() {
        ...
        t[ht.expando] = 1,
        ut.attributes = !t.getAttribute(ht.expando)
    }();
    var Ft = {
    ...
    !function() {
        ...
        for (e in {
            ...
            n = "on" + e,
            (ut[e] = n in t) || (i.setAttribute(n, "t"),
    ...
    ht.event = {
        ...
        add: function(t, e, n, i, o) {
            ...
            if (m) {
                ...
                ,
                u.elem = t),
                a = (e = (e || "").match(kt) || [""]).length; a--; )
                    r = Gt.exec(e[a]) || [],
                    p = g = r[1],
                    f = (r[2] || "").split(".").sort(),
                    p && (c = ht.event.special[p] || {},
                    p = (o ? c.delegateType : c.bindType) || p,
                    c = ht.event.special[p] || {},
                    d = ht.extend({
                        type: p,
                        origType: g,
                        data: i,
                    ...
                    (h = s[p]) || (h = s[p] = [],
                    h.delegateCount = 0,
                    c.setup && !1 !== c.setup.call(t, i, f, u) || (t.addEventListener ? t.addEventListener(p, u, !1) : t.attachEvent && t.attachEvent("on" + p, u))),
        ...
        trigger: function(e, n, i, o) {
            var r, s, a, l, c, u, d, h = [i || nt], p = ct.call(e, "type") ? e.type : e, f = ct.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = u = i = i || nt,
            3 !== i.nodeType && 8 !== i.nodeType && !Yt.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."),
            p = f.shift(),
            f.sort()),
            s = p.indexOf(":") < 0 && "on" + p,
            ...
            o || !c.trigger || !1 !== c.trigger.apply(i, n))) {
                if (!o && !c.noBubble && !ht.isWindow(i)) {
                    ...
                    Yt.test(l + p) || (a = a.parentNode); a; a = a.parentNode)
                        h.push(a),
                        u = a;
                ...
                for (d = 0; (a = h[d++]) && !e.isPropagationStopped(); )
                    ...
                    (r = (ht._data(a, "events") || {})[e.type] && ht._data(a, "handle")) && r.apply(a, n),
                    (r = s && a[s]) && r.apply && At(a) && (e.result = r.apply(a, n),
                    !1 === e.result && e.preventDefault());
                if (e.type = p,
                !o && !e.isDefaultPrevented() && (!c._default || !1 === c._default.apply(h.pop(), n)) && At(i) && s && i[p] && !ht.isWindow(i)) {
                    (u = i[s]) && (i[s] = null),
        ...
        dispatch: function(t) {
            t = ht.event.fix(t);
            var e, n, i, o, r, s = [], a = it.call(arguments), l = (ht._data(this, "events") || {})[t.type] || [], c = ht.event.special[t.type] || {};
            if (a[0] = t,
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
                ...
                e = 0; (o = s[e++]) && !t.isPropagationStopped(); )
                    ...
                    n = 0; (r = o.handlers[n++]) && !t.isImmediatePropagationStopped(); )
                        ...
                        t.data = r.data,
                        void 0 !== (i = ((ht.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (t.result = i) && (t.preventDefault(),
                        t.stopPropagation()));
        ...
        fix: function(t) {
            ...
            for (s || (this.fixHooks[o] = s = Vt.test(o) ? this.mouseHooks : Qt.test(o) ? this.keyHooks : {}),
            i = s.props ? this.props.concat(s.props) : this.props,
            t = new ht.Event(r),
            e = i.length; e--; )
                n = i[e],
                t[n] = r[n];
            return t.target || (t.target = r.srcElement || nt),
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                return null == t.pageX && null != e.clientX && (i = t.target.ownerDocument || nt,
                o = i.documentElement,
                n = i.body,
    ...
    ht.Event = function(t, e) {
        ...
        this.type = t.type,
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? y : w) : this.type = t,
        e && ht.extend(this, e),
    ...
    ht.extend({
        ...
        clone: function(t, e, n) {
            ...
            if (ut.html5Clone || ht.isXMLDoc(t) || !Kt.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (oe.innerHTML = t.outerHTML,
            oe.removeChild(r = oe.firstChild)),
            !(ut.noCloneEvent && ut.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ht.isXMLDoc(t)))
                for (i = f(r),
                a = f(t),
                s = 0; null != (o = a[s]); ++s)
                    i[s] && E(o, i[s]);
            if (e)
                if (n)
                    ...
                    _(t, r);
            return (i = f(r, "script")).length > 0 && g(i, !l && f(t, "script")),
            i = a = o = null,
            r
        },
        ...
        html: function(t) {
            return jt(this, function(t) {
                ...
                if ("string" == typeof t && !te.test(t) && (ut.htmlSerialize || !Kt.test(t)) && (ut.leadingWhitespace || !Rt.test(t)) && !Ft[(Ht.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i > n; n++)
                            1 === (e = this[n] || {}).nodeType && (ht.cleanData(f(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
    ...
    var re, se = {
        HTML: "block",
        BODY: "block"
    }, ae = /^margin/, le = new RegExp("^(" + Dt + ")(?!px)[a-z%]+$","i"), ce = function(t, e, n, i) {
        var o, r, s = {};
        for (r in e)
            s[r] = t.style[r],
            t.style[r] = e[r];
    ...
    !function() {
        ...
        var n, i, o, r, s, a, l = nt.createElement("div"), c = nt.createElement("div");
        ...
        (l = nt.createElement("div")).style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute",
        c.innerHTML = "",
        l.appendChild(c),
        ut.boxSizing = "" === c.style.boxSizing || "" === c.style.MozBoxSizing || "" === c.style.WebkitBoxSizing,
        ht.extend(ut, {
    ...
    he = function(t, e, n) {
        ...
        return n = n || de(t),
        "" !== (s = n ? n.getPropertyValue(e) || n[e] : void 0) && void 0 !== s || ht.contains(t.ownerDocument, t) || (s = ht.style(t, e)),
        n && !ut.pixelMarginRight() && le.test(s) && ae.test(e) && (i = a.width,
        o = a.minWidth,
        r = a.maxWidth,
    ...
    ht.extend({
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                if (e = ht.cssProps[a] || (ht.cssProps[a] = O(a) || a),
                s = ht.cssHooks[e] || ht.cssHooks[a],
                void 0 === n)
                    return s && "get"in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e];
                if ("string" === (r = typeof n) && (o = Pt.exec(n)) && o[1] && (n = h(t, e, o),
                r = "number"),
                null != n && n === n && ("number" === r && (n += o && o[3] || (ht.cssNumber[a] ? "" : "px")),
                ut.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"),
        ...
        css: function(t, e, n, i) {
            ...
            return e = ht.cssProps[a] || (ht.cssProps[a] = O(a) || a),
            (s = ht.cssHooks[e] || ht.cssHooks[a]) && "get"in s && (r = s.get(t, !0, n)),
            void 0 === r && (r = he(t, e, i)),
    ...
    ut.opacity || (ht.cssHooks.opacity = {
        ...
        set: function(t, e) {
            ...
            n.zoom = 1,
            (e >= 1 || "" === e) && "" === ht.trim(r.replace(fe, "")) && n.removeAttribute && (n.removeAttribute("filter"),
            "" === e || i && !i.filter) || (n.filter = fe.test(r) ? r.replace(fe, o) : r + " " + o)
        }
    }),
    ...
    ht.fx = j.prototype.init,
    ht.fx.step = {};
    var Ce, Te, Se = /^(?:toggle|show|hide)$/, _e = /queueHooks$/;
    ht.Animation = ht.extend(q, {
        tweeners: {
            "*": [function(t, e) {
                var n = this.createTween(t, e);
                return h(n.elem, t, Pt.exec(e), n),
                n
            }
            ]
        },
        ...
        prefilters: [function(t, e, n) {
            var i, o, r, s, a, l, c, u = this, d = {}, h = t.style, p = t.nodeType && Mt(t), f = ht._data(t, "fxshow");
            n.queue || (null == (a = ht._queueHooks(t, "fx")).unqueued && (a.unqueued = 0,
            l = a.empty.fire,
            ...
            "inline" === ("none" === (c = ht.css(t, "display")) ? ht._data(t, "olddisplay") || A(t.nodeName) : c) && "none" === ht.css(t, "float") && (ut.inlineBlockNeedsLayout && "inline" !== A(t.nodeName) ? h.zoom = 1 : h.display = "inline-block")),
            ...
            if (ht.isEmptyObject(d))
                "inline" === ("none" === c ? A(t.nodeName) : c) && (h.display = c);
            else {
                f ? "hidden"in f && (p = f.hidden) : f = ht._data(t, "fxshow", {}),
                r && (f.hidden = !p),
                p ? ht(t).show() : u.done(function() {
                    ht(t).hide()
                }),
                u.done(function() {
                    var e;
    ...
    ,
    function() {
        var t, e = nt.createElement("input"), n = nt.createElement("div"), i = nt.createElement("select"), o = i.appendChild(nt.createElement("option"));
    ...
    ht.fn.extend({
        val: function(t) {
            var e, n, i, o = this[0];
            return arguments.length ? (i = ht.isFunction(t),
    ...
    var $e, Ne, Ae = ht.expr.attrHandle, Ie = /^(?:checked|selected)$/i, Oe = ut.getSetAttribute, De = ut.input;
    ht.fn.extend({
        attr: function(t, e) {
    ...
    ht.extend({
        attr: function(t, e, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === t.getAttribute ? ht.prop(t, e, n) : (1 === r && ht.isXMLDoc(t) || (e = e.toLowerCase(),
                o = ht.attrHooks[e] || (ht.expr.match.bool.test(e) ? Ne : $e)),
                void 0 !== n ? null === n ? void ht.removeAttr(t, e) : o && "set"in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""),
                n) : o && "get"in o && null !== (i = o.get(t, e)) ? i : null == (i = ht.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        removeAttr: function(t, e) {
            ...
            if (r && 1 === t.nodeType)
                for (; n = r[o++]; )
                    i = ht.propFix[n] || n,
                    ht.expr.match.bool.test(n) ? De && Oe || !Ie.test(n) ? t[i] = !1 : t[ht.camelCase("default-" + n)] = t[i] = !1 : ht.attr(t, n, ""),
                    t.removeAttribute(Oe ? n : i)
        }
    }),
    Ne = {
        set: function(t, e, n) {
            return !1 === e ? ht.removeAttr(t, n) : De && Oe || !Ie.test(n) ? t.setAttribute(!Oe && ht.propFix[n] || n, n) : t[ht.camelCase("default-" + n)] = t[n] = !0,
            n
        }
    },
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ht.isFunction(t) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    void 0 !== t && "boolean" !== n || ((e = F(this)) && ht._data(this, "__className__", e),
                    ht.attr(this, "class", e || !1 === t ? "" : ht._data(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, n, i = 0;
            for (e = " " + t + " "; n = this[i++]; )
                if (1 === n.nodeType && (" " + F(n) + " ").replace(Me, " ").indexOf(e) > -1)
                    return !0;
            return !1
        }
    }),
    ...
    ht.extend({
        ...
        ajax: function(e, n) {
            function i(e, n, i, o) {
                ...
                i && (w = Q(h, C, i)),
                w = V(h, w, C, r),
                r ? (h.ifModified && ((x = C.getResponseHeader("Last-Modified")) && (ht.lastModified[s] = x),
                (x = C.getResponseHeader("etag")) && (ht.etag[s] = x)),
                204 === e || "HEAD" === h.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = w.state,
                d = w.data,
                y = w.error,
                r = !y)) : (y = T,
                !e && T || (T = "error",
                ...
                C.status = e,
                C.statusText = (n || T) + "",
                r ? g.resolveWith(p, [d, T, C]) : g.rejectWith(p, [C, T, y]),
                C.statusCode(v),
                v = void 0,
                c && f.trigger(r ? "ajaxSuccess" : "ajaxError", [C, h, r ? d : y]),
                m.fireWith(p, [C, T]),
                c && (f.trigger("ajaxComplete", [C, h]),
                --ht.active || ht.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (n = e,
            e = void 0),
            n = n || {};
            var o, r, s, a, l, c, u, d, h = ht.ajaxSetup({}, n), p = h.context || h, f = h.context && (p.nodeType || p.jquery) ? ht(p) : ht.event, g = ht.Deferred(), m = ht.Callbacks("once memory"), v = h.statusCode || {}, y = {}, w = {}, b = 0, x = "canceled", C = {
                readyState: 0,
            ...
            C.success = C.done,
            C.error = C.fail,
            h.url = ((e || h.url || Ze) + "").replace(Re, "").replace(Xe, Ke[1] + "//"),
            h.type = n.method || n.type || h.method || h.type,
            h.dataTypes = ht.trim(h.dataType || "*").toLowerCase().match(kt) || [""],
            null == h.crossDomain && (o = Qe.exec(h.url.toLowerCase()),
            h.crossDomain = !(!o || o[1] === Ke[1] && o[2] === Ke[2] && (o[3] || ("http:" === o[1] ? "80" : "443")) === (Ke[3] || ("http:" === Ke[1] ? "80" : "443")))),
            h.data && h.processData && "string" != typeof h.data && (h.data = ht.param(h.data, h.traditional)),
            U(Ve, h, n, C),
            2 === b)
                return C;
            (c = ht.event && h.global) && 0 == ht.active++ && ht.event.trigger("ajaxStart"),
            h.type = h.type.toUpperCase(),
            h.hasContent = !Ue.test(h.type),
            s = h.url,
            h.hasContent || (h.data && (s = h.url += (He.test(s) ? "&" : "?") + h.data,
            delete h.data),
            !1 === h.cache && (h.url = qe.test(s) ? s.replace(qe, "$1_=" + ze++) : s + (He.test(s) ? "&" : "?") + "_=" + ze++)),
            h.ifModified && (ht.lastModified[s] && C.setRequestHeader("If-Modified-Since", ht.lastModified[s]),
            ht.etag[s] && C.setRequestHeader("If-None-Match", ht.etag[s])),
            (h.data && h.hasContent && !1 !== h.contentType || n.contentType) && C.setRequestHeader("Content-Type", h.contentType),
            C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Ge + "; q=0.01" : "") : h.accepts["*"]);
            for (r in h.headers)
                C.setRequestHeader(r, h.headers[r]);
            if (h.beforeSend && (!1 === h.beforeSend.call(p, C, h) || 2 === b))
                return C.abort();
            x = "abort";
            for (r in {
                success: 1,
    ...
    (an = ut.ajax = !!an) && ht.ajaxTransport(function(e) {
    ...
    ht.ajaxPrefilter("json jsonp", function(e, n, i) {
        ...
        a ? e[a] = e[a].replace(cn, "$1" + o) : !1 !== e.jsonp && (e.url += (He.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
    ...
    ht.offset = {
        setOffset: function(t, e, n) {
            var i, o, r, s, a, l, c = ht.css(t, "position"), u = ht(t), d = {};
            "static" === c && (t.style.position = "relative"),
            a = u.offset(),
            r = ht.css(t, "top"),
            l = ht.css(t, "left"),
            ("absolute" === c || "fixed" === c) && ht.inArray("auto", [r, l]) > -1 ? (i = u.position(),
            s = i.top,
    ...
    ht.fn.extend({
        offset: function(t) {
            ...
            ht.contains(e, o) ? (void 0 !== o.getBoundingClientRect && (i = o.getBoundingClientRect()),
            n = tt(r),
            {
    ...
    ht.each(["top", "left"], function(t, e) {
        ht.cssHooks[e] = I(ut.pixelPosition, function(t, n) {
            return n ? (n = he(t, e),
            le.test(n) ? ht(t).position()[e] + "px" : n) : void 0
        })
    }),
    ht.each({
        Height: "height",
...
jQuery.extend(jQuery.easing, {
    ...
    easeInOutBack: function(t, e, n, i, o, r) {
        return void 0 == r && (r = 1.70158),
        (e /= o / 2) < 1 ? i / 2 * (e * e * ((1 + (r *= 1.525)) * e - r)) + n : i / 2 * ((e -= 2) * e * ((1 + (r *= 1.525)) * e + r) + 2) + n
    },
...
function(t, e, n, i) {
    ...
    o.prototype = {
        ...
        _defineElements: function() {
            ...
            this.$viewportElement = this.options.viewportElement !== i ? t(this.options.viewportElement) : this.$scrollElement[0] === e || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        _defineSetters: function() {
            ...
            : t.noop,
            this._setPosition = i.setPosition || function(t, n, o, r, s) {
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                var n, o, r, s, a, l, c, u, d, h = t(this), p = 0, f = 0, g = 0, m = 0;
                ...
                h.parents().each(function() {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (p = g,
                    f = m,
                    c = e,
                    !1) : (g += e.position().left,
                    void (m += e.position().top))
                }),
                n = h.data("stellar-horizontal-offset") !== i ? h.data("stellar-horizontal-offset") : c !== i && c.data("stellar-horizontal-offset") !== i ? c.data("stellar-horizontal-offset") : e.horizontalOffset,
                o = h.data("stellar-vertical-offset") !== i ? h.data("stellar-vertical-offset") : c !== i && c.data("stellar-vertical-offset") !== i ? c.data("stellar-vertical-offset") : e.verticalOffset,
                e.particles.push({
                    $element: h,
                    $offsetParent: c,
        ...
        _findBackgrounds: function() {
            ...
            e.each(function() {
                var e, s, a, l, c, u, p, f = t(this), g = h(f), m = 0, v = 0, y = 0, w = 0;
                if (f.data("stellar-backgroundIsActive")) {
                    if (f.data("stellar-backgroundIsActive") !== this)
                        return
                } else
                    f.data("stellar-backgroundIsActive", this);
                f.data("stellar-backgroundStartingLeft") ? d(f, f.data("stellar-backgroundStartingLeft"), f.data("stellar-backgroundStartingTop")) : (f.data("stellar-backgroundStartingLeft", g[0]),
                ...
                f.parents().each(function() {
                    var e = t(this);
                    return !0 === e.data("stellar-offset-parent") ? (m = y,
                    v = w,
                    p = e,
                    !1) : (y += e.position().left,
                    void (w += e.position().top))
                }),
                e = f.data("stellar-horizontal-offset") !== i ? f.data("stellar-horizontal-offset") : p !== i && p.data("stellar-horizontal-offset") !== i ? p.data("stellar-horizontal-offset") : n.horizontalOffset,
                s = f.data("stellar-vertical-offset") !== i ? f.data("stellar-vertical-offset") : p !== i && p.data("stellar-vertical-offset") !== i ? p.data("stellar-vertical-offset") : n.verticalOffset,
                n.backgrounds.push({
                    $element: f,
                    $offsetParent: p,
        ...
        _reset: function() {
            ...
            for (o = this.backgrounds.length - 1; o >= 0; o--)
                (i = this.backgrounds[o]).$element.data("stellar-backgroundStartingLeft", null).data("stellar-backgroundStartingTop", null),
        ...
        _repositionElements: function() {
            var t, e, n, i, o, r, s, a, l, c, u = this._getScrollLeft(), h = this._getScrollTop(), p = !0, f = !0;
            if (this.currentScrollLeft !== u || this.currentScrollTop !== h || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                ...
                c = this.particles.length - 1; c >= 0; c--)
                    ...
                    this.options.verticalScrolling ? (s = (h + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop,
                    ...
                    p = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : h) && l < (t.isFixed ? 0 : h) + this.viewportHeight + this.viewportOffsetTop),
                ...
                for (c = this.backgrounds.length - 1; c >= 0; c--)
                    ...
                    e = n.isFixed ? 0 : 1,
                    i = this.options.horizontalScrolling ? (u + n.horizontalOffset - this.viewportOffsetLeft - n.startingOffsetLeft + n.parentOffsetLeft - n.startingBackgroundPositionLeft) * (e - n.stellarRatio) + "px" : n.startingValueLeft,
                    o = this.options.verticalScrolling ? (h + n.verticalOffset - this.viewportOffsetTop - n.startingOffsetTop + n.parentOffsetTop - n.startingBackgroundPositionTop) * (e - n.stellarRatio) + "px" : n.startingValueTop,
                    d(n.$element, i, o)
            }
        },
        _handleScrollEvent: function() {
            ...
            this.$scrollElement.bind("scroll." + this.name, i),
            i()
        },
    ...
    t.fn[r] = function(e) {
        ...
        return e === i || "object" == typeof e ? this.each(function() {
            ...
            i instanceof o && "function" == typeof i[e] && i[e].apply(i, Array.prototype.slice.call(n, 1)),
...
function(t) {
    ...
    t.flexslider = function(n, i) {
        ...
        var r, s = o.vars.namespace, a = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, l = ("ontouchstart"in window || a || window.DocumentTouch && document instanceof DocumentTouch) && o.vars.touch, c = "click touchend MSPointerUp keyup", u = "", d = "vertical" === o.vars.direction, h = o.vars.reverse, p = o.vars.itemWidth > 0, f = "fade" === o.vars.animation, g = "" !== o.vars.asNavFor, m = {};
        ...
        m = {
            ...
            asNav: {
                setup: function() {
                    ...
                    o.slides.each(function() {
                        ...
                        var n = t(this)
                          , i = n.index();
                        0 >= n.offset().left - t(o).scrollLeft() && n.hasClass(s + "active-slide") ? o.flexAnimate(o.getTarget("prev"), !0) : t(o.vars.asNavFor).data("flexslider").animating || n.hasClass(s + "active-slide") || (o.direction = o.currentItem < i ? "next" : "prev",
                        o.flexAnimate(i, o.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function() {
                    var e, n, i = "thumbnails" === o.vars.controlNav ? "control-thumbs" : "control-paging", r = 1;
                    if (o.controlNavScaffold = t('<ol class="' + s + "control-nav " + s + i + '"></ol>'),
                    o.pagingCount > 1)
                        for (var a = 0; a < o.pagingCount; a++) {
                            if (void 0 === (n = o.slides.eq(a)).attr("data-thumb-alt") && n.attr("data-thumb-alt", ""),
                            altText = "" !== n.attr("data-thumb-alt") ? altText = ' alt="' + n.attr("data-thumb-alt") + '"' : "",
                            e = "thumbnails" === o.vars.controlNav ? '<img src="' + n.attr("data-thumb") + '"' + altText + "/>" : '<a href="#">' + r + "</a>",
                    ...
                    o.controlNavScaffold.delegate("a, img", c, function(e) {
                        ...
                        "" === u || u === e.type) {
                            ...
                            n.hasClass(s + "active") || (o.direction = i > o.currentSlide ? "next" : "prev",
                ...
                setupManual: function() {
                    ...
                    o.controlNav.bind(c, function(e) {
                        ...
                        "" === u || u === e.type) {
                            var n = t(this)
                              , i = o.controlNav.index(n);
                            n.hasClass(s + "active") || (i > o.currentSlide ? o.direction = "next" : o.direction = "prev",
                            o.flexAnimate(i, o.vars.pauseOnAction))
                        }
                        "" === u && (u = e.type),
                        m.setToClearWatchedEvent()
                ...
                update: function(e, n) {
                    ...
                    m.controlNav.set(),
                    o.pagingCount > 1 && o.pagingCount !== o.controlNav.length ? o.update(n, e) : m.controlNav.active()
                }
            },
            directionNav: {
                setup: function() {
                    ...
                    o.directionNav = t("." + s + "direction-nav li a", o.controlsContainer)) : (o.append(e),
                    o.directionNav = t("." + s + "direction-nav li a", o)),
                    m.directionNav.update(),
                    o.directionNav.bind(c, function(e) {
                        e.preventDefault();
                        var n;
                        ("" === u || u === e.type) && (n = t(this).hasClass(s + "next") ? o.getTarget("next") : o.getTarget("prev"),
                        o.flexAnimate(n, o.vars.pauseOnAction)),
                        "" === u && (u = e.type),
                        m.setToClearWatchedEvent()
                    })
            ...
            pausePlay: {
                setup: function() {
                    ...
                    o.pausePlay = t("." + s + "pauseplay a", o.controlsContainer)) : (o.append(e),
                    o.pausePlay = t("." + s + "pauseplay a", o)),
                    m.pausePlay.update(o.vars.slideshow ? s + "pause" : s + "play"),
                    o.pausePlay.bind(c, function(e) {
                        e.preventDefault(),
                        ("" === u || u === e.type) && (t(this).hasClass(s + "pause") ? (o.manualPause = !0,
                        o.manualPlay = !1,
            ...
            touch: function() {
                var t, e, i, r, s, l, c, u, g, m = !1, v = 0, y = 0, w = 0;
                a ? (n.style.msTouchAction = "none",
                ...
                n.addEventListener("MSPointerDown", function(t) {
                    ...
                    r = d ? o.h : o.w,
                    l = Number(new Date),
                    i = p && h && o.animatingTo === o.last ? 0 : p && h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : p && o.currentSlide === o.last ? o.limit : p ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : h ? (o.last - o.currentSlide + o.cloneOffset) * r : (o.currentSlide + o.cloneOffset) * r)
                }, !1),
                n._slider = o,
                n.addEventListener("MSGestureChange", function(t) {
                    ...
                    if (e) {
                        ...
                        return w += d ? a : o,
                        s = w,
                        m = d ? Math.abs(w) < Math.abs(-o) : Math.abs(w) < Math.abs(-a),
                        t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                            n._gesture.stop()
                        }) : void ((!m || Number(new Date) - l > 500) && (t.preventDefault(),
                        !f && e.transitions && (e.vars.animationLoop || (s = w / (0 === e.currentSlide && 0 > w || e.currentSlide === e.last && w > 0 ? Math.abs(w) / r + 2 : 1)),
                        e.setProps(i + s, "setTouch"))))
                    }
                }, !1),
                n.addEventListener("MSGestureEnd", function(n) {
                    ...
                    o.animating ? s.preventDefault() : (window.navigator.msPointerEnabled || 1 === s.touches.length) && (o.pause(),
                    r = d ? o.h : o.w,
                    l = Number(new Date),
                    v = s.touches[0].pageX,
                    y = s.touches[0].pageY,
                    ...
                    n.addEventListener("touchend", g, !1))
                }
                ,
                u = function(n) {
                    v = n.touches[0].pageX,
                    y = n.touches[0].pageY,
                    s = d ? t - y : t - v;
                    (!(m = d ? Math.abs(s) < Math.abs(v - e) : Math.abs(s) < Math.abs(y - e)) || Number(new Date) - l > 500) && (n.preventDefault(),
                    !f && o.transitions && (o.vars.animationLoop || (s /= 0 === o.currentSlide && 0 > s || o.currentSlide === o.last && s > 0 ? Math.abs(s) / r + 2 : 1),
                    o.setProps(i + s, "setTouch")))
                }
                ,
                g = function(a) {
                    if (n.removeEventListener("touchmove", u, !1),
                    ...
                    n.removeEventListener("touchend", g, !1),
                    t = null,
                    e = null,
                    s = null,
                    i = null
            ...
            resize: function() {
                !o.animating && o.is(":visible") && (p || o.doMath(),
                f ? m.smoothHeight() : p ? (o.slides.width(o.computedW),
                o.update(o.pagingCount),
                o.setProps()) : d ? (o.viewport.height(o.h),
                o.setProps(o.h, "setTotal")) : (o.vars.smoothHeight && m.smoothHeight(),
        ...
        o.flexAnimate = function(e, n, i, r, a) {
            ...
            !o.animating && (o.canAdvance(e, a) || i) && o.is(":visible")) {
                if (g && r) {
                    var c = t(o.vars.asNavFor).data("flexslider");
                    if (o.atEnd = 0 === e || e === o.count - 1,
                    c.flexAnimate(e, !0, !1, !0, a),
                    ...
                    Math.ceil((e + 1) / o.visible) - 1 === o.currentSlide || 0 === e)
                        ...
                        o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"),
                        !1;
                    o.currentItem = e,
                    o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"),
                ...
                p || o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"),
                ...
                f)
                    ...
                    p ? (u = o.vars.itemMargin,
                    y = (o.itemW + u) * o.move * o.animatingTo,
                    v = y > o.limit && 1 !== o.visible ? o.limit : y) : v = 0 === o.currentSlide && e === o.count - 1 && o.vars.animationLoop && "next" !== o.direction ? h ? (o.count + o.cloneOffset) * w : 0 : o.currentSlide === o.last && 0 === e && o.vars.animationLoop && "prev" !== o.direction ? h ? 0 : (o.count + 1) * w : h ? (o.count - 1 - e + o.cloneOffset) * w : (e + o.cloneOffset) * w,
        ...
        o.setProps = function(t, e, n) {
            var i = function() {
                ...
                return -1 * function() {
                    if (p)
                        return "setTouch" === e ? t : h && o.animatingTo === o.last ? 0 : h ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : o.animatingTo === o.last ? o.limit : n;
                    switch (e) {
                    case "setTotal":
        ...
        o.setup = function(e) {
            if (f)
                ...
                o.cloneCount = 0,
                o.cloneOffset = 0,
                h && (i = t.makeArray(o.slides).reverse(),
                o.slides = t(i),
                o.container.empty().append(o.slides))),
                ...
                d && !p ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"),
                setTimeout(function() {
                    o.newSlides.css({
                        display: "block"
                    }),
        ...
        o.update = function(t, e) {
            o.doMath(),
            p || (t < o.currentSlide ? o.currentSlide += 1 : t <= o.currentSlide && 0 !== t && (o.currentSlide -= 1),
            o.animatingTo = o.currentSlide),
            o.vars.controlNav && !o.manualControls && ("add" === e && !p || o.pagingCount > o.controlNav.length ? m.controlNav.update("add") : ("remove" === e && !p || o.pagingCount < o.controlNav.length) && (p && o.currentSlide > o.last && (o.currentSlide -= 1,
            o.animatingTo -= 1),
        ...
        o.addSlide = function(e, n) {
            ...
            o.count += 1,
            o.last = o.count - 1,
            d && h ? void 0 !== n ? o.slides.eq(o.count - n).after(i) : o.container.prepend(i) : void 0 !== n ? o.slides.eq(n).before(i) : o.container.append(i),
            o.update(n, "add"),
        ...
        o.removeSlide = function(e) {
            ...
            o.count -= 1,
            o.last = o.count - 1,
            isNaN(e) ? t(e, o.slides).remove() : d && h ? o.slides.eq(o.last).remove() : o.slides.eq(e).remove(),
            o.doMath(),
            o.update(n, "remove"),
            o.slides = t(o.vars.selector + ":not(.clone)", o),
            o.setup(),
    ...
    t.fn.extend({
        appear: function(e) {
            ...
            if (!r) {
                var c = function() {
                    s || (s = !0,
                    setTimeout(n, o.interval))
                };
                t(window).scroll(c).resize(c),
                r = !0
            }
            return o.force_process && setTimeout(n, o.interval),
            i(l),
            t(l)
        }
    }),
...
function(t) {
    var e, n, i, o, r, s, a, l = "Close", c = "BeforeClose", u = "MarkupParse", d = "Open", h = "Change", p = "mfp", f = "." + p, g = "mfp-ready", m = "mfp-removing", v = "mfp-prevent-close", y = function() {}, w = !!window.jQuery, b = t(window), x = function(t, n) {
        e.ev.on(p + t + f, n)
    }, C = function(e, n, i, o) {
    ...
    y.prototype = {
        ...
        open: function(n) {
                ...
                e.index = n.index || 0;
            {
                if (!e.isOpen) {
                    ...
                    e.bgOverlay || (e.bgOverlay = C("bg").on("click" + f, function() {
                        e.close()
                    }),
                    ...
                    T("BeforeOpen"),
                    e.st.showCloseBtn && (e.st.closeBtnInside ? (x(u, function(t, e, n, i) {
        ...
        updateItemHTML: function() {
            ...
            var i = n.type;
            if (T("BeforeChange", [e.currItem ? e.currItem.type : "", i]),
            e.currItem = n,
            !e.currTemplate[i]) {
        ...
        appendContent: function(t, n) {
            e.content = t,
            t ? e.st.showCloseBtn && e.st.closeBtnInside && !0 === e.currTemplate[n] ? e.content.find(".mfp-close").length || e.content.append(S()) : e.content = t : e.content = "",
            T("BeforeAppend"),
    ...
    ;
    var k, $, N, A = "inline", I = function() {
        N && ($.after(N.addClass(k)).detach(),
        N = null)
    };
            ...
            getInline: function(n, i) {
                ...
                n.src) {
                    ...
                    if (r.length) {
                        ...
                        s && s.tagName && ($ || (k = o.hiddenClass,
                        $ = C(k),
                        k = "mfp-" + k),
                        N = r.after($).detach().removeClass(k)),
                ...
                var n = 0
                  ...
                  , o = function(r) {
                    ...
                    M = setInterval(function() {
                        return i.naturalWidth > 0 ? void e._onImageHasSize(t) : (n > 200 && clearInterval(M),
            ...
            getImage: function(n, i) {
                var o = 0
                  , r = function() {
                    ...
                    n.hasSize = !0,
                    n.loaded = !0,
                    T("ImageLoadComplete")) : 200 > ++o ? setTimeout(r, 100) : s())
                }
                  , s = function() {
        ...
        proto: {
            initZoom: function() {
                ...
                if (n.enabled && e.supportsTransition) {
                    var o, r, s = n.duration, a = function(t) {
            ...
            _getOffset: function(n) {
                var i, o = (i = n ? e.currItem.img : e.st.zoom.opener(e.currItem.el || e.currItem)).offset(), r = parseInt(i.css("padding-top"), 10), s = parseInt(i.css("padding-bottom"), 10);
                o.top -= t(window).scrollTop() - r;
                var a = {
                    width: i.width(),
                    height: (w ? i.innerHeight() : i[0].offsetHeight) - s - r
                };
                return H() ? a["-moz-transform"] = a.transform = "translate(" + o.left + "px," + o.top + "px)" : (a.left = o.left,
                a.top = o.top),
                a
            }
        }
            ...
            return t(this).each(function() {
                ...
                if (e) {
                    ...
                    s.on("touchstart" + i, function(t) {
                        ...
                        l = d.clientX,
                        c = d.clientY,
                        b.on("touchmove" + i, function(t) {
                            d = t.originalEvent ? t.originalEvent.touches : t.touches,
                            h = d.length,
                            d = d[0],
                            (Math.abs(d.clientX - l) > 10 || Math.abs(d.clientY - c) > 10) && (u = !0,
                            n())
...
function(t, e, n, i) {
    ...
    function s(t) {
        var e, i, o = n.createElement("div"), r = t;
        for (e in r)
            if (i = r[e],
            void 0 !== o.style[i])
                return o = null,
    ...
    o.Pipe = [{
        ...
        run: function() {
            ...
            for (t = 0,
            e = Math.abs(o / 2); e > t; t++)
                o > 0 ? (this.$stage.children().eq(i.length + n.length - 1).remove(),
                n.pop(),
                this.$stage.children().eq(0).remove(),
                n.pop()) : (n.push(n.length / 2),
                this.$stage.append(i[n[n.length - 1]].clone().addClass("cloned")),
        ...
        run: function() {
            ...
            e = 0,
            n = this._clones.length + this._items.length; n > e; e++)
                t = this._mergers[this.relative(e)],
                t = this.settings.mergeFit && Math.min(t, this.settings.items) || t,
                r += (this.settings.autoWidth ? this._items[this.relative(e)].width() + this.settings.margin : o * t) * i,
                this._coordinates.push(r)
        }
    }, {
        filter: ["width", "items", "settings"],
        run: function() {
            var e, n, i = (this.width() / this.settings.items).toFixed(3), o = {
            ...
            !this.settings.autoWidth && t.grep(this._mergers, function(t) {
                ...
                for (e = 0,
                n = this._coordinates.length; n > e; e++)
                    o.width = Math.abs(this._coordinates[e]) - Math.abs(this._coordinates[e - 1] || 0) - this.settings.margin,
        ...
        run: function() {
            ...
            for (n = 0,
            i = this._coordinates.length; i > n; n++)
    ...
    o.prototype.setup = function() {
        ...
        }).addClass("owl-responsive-" + i)) : o = t.extend({}, this.options),
    ...
    o.prototype.onDragStart = function(i) {
        var o, s, a, l;
        if (3 === (o = i.originalEvent || i || e.event).which || this.state.isTouch)
            return !1;
        if ("mousedown" === o.type && this.$stage.addClass("owl-grab"),
        this.trigger("drag"),
    ...
    o.prototype.onDragMove = function(t) {
        var n, o, s, a, l, c;
        this.state.isTouch && (this.state.isScrolling || (n = t.originalEvent || t || e.event,
        o = r(n).x,
        s = r(n).y,
        ...
        (this.drag.distance > 8 || this.drag.distance < -8) && (n.preventDefault !== i ? n.preventDefault() : n.returnValue = !1,
    ...
    o.prototype.onDragEnd = function(e) {
        ...
        if (this.state.isTouch) {
            ...
            (Math.abs(this.drag.distance) > 3 || i > 300) && this.removeClick(this.drag.targetEl),
    ...
    o.prototype.closest = function(e) {
        ...
        return this.settings.freeDrag || t.each(o, t.proxy(function(t, r) {
            return e > r - 30 && r + 30 > e ? n = t : this.op(e, "<", r) && this.op(e, ">", o[t + 1] || r - i) && (n = "left" === this.state.direction ? t + 1 : t),
            -1 === n
        }, this)),
    ...
    o.prototype.maximum = function(t) {
        ...
        if (!r.loop && r.center)
            ...
            if (r.loop || r.center)
                ...
                for (revert = r.rtl ? 1 : -1,
                n = this.$stage.width() - this.$element.width(); (i = this.coordinates(o)) && !(i * revert >= n); )
                    e = ++o
            }
        else
            e = this._items.length - r.items;
    ...
    o.prototype.coordinates = function(e) {
        ...
        }, this)) : (this.settings.center ? (n = this._coordinates[e],
        n += (this.width() - n + (this._coordinates[e - 1] || 0)) / 2 * (this.settings.rtl ? -1 : 1)) : n = this._coordinates[e - 1] || 0,
        n)
    }
    ,
    ...
    o.prototype.to = function(n, i) {
        if (this.settings.loop) {
            ...
            a < this.settings.items && !1 === l ? (r = s + this._items.length,
            this.reset(r)) : a >= c - this.settings.items && !0 === l && (r = s - this._items.length,
            this.reset(r)),
            e.clearTimeout(this.e._goToLoop),
            this.e._goToLoop = e.setTimeout(t.proxy(function() {
                this.speed(this.duration(this.current(), r + o, i)),
                this.current(r + o),
                this.update()
            }, this), 30)
        } else
            this.speed(this.duration(this.current(), n, i)),
            this.current(n),
            this.update()
    }
    ,
    ...
    o.prototype.addTriggerableEvents = function() {
        var e = t.proxy(function(e, n) {
            return t.proxy(function(t) {
                t.relatedTarget !== this && (this.suppress([n]),
    ...
    o.prototype.watchVisibility = function() {
        ...
        n(this.$element.get(0)) || (this.$element.addClass("owl-hidden"),
    ...
    o.prototype.preloadAutoWidthImages = function(e) {
        ...
        e.each(function(s, a) {
            ...
            (r = new Image).onload = function() {
                ...
                o.attr("src", r.src),
                o.css("opacity", 1),
                n >= e.length && (i.state.imagesLoaded = !0,
                i.initialize())
            }
            ,
...
function(t, e, n) {
    ...
    i.prototype.thumbnail = function(e, n) {
        var i, o, r, s = n.width && n.height ? 'style="width:' + n.width + "px;height:" + n.height + 'px;"' : "", a = e.find("img"), l = "src", c = "", u = this._core.settings, d = function(t) {
        ...
        a.length ? (d(a.attr(l)),
        a.remove(),
        !1) : void ("youtube" === n.type ? (r = "http://img.youtube.com/vi/" + n.id + "/hqdefault.jpg",
    ...
    i.prototype.play = function(e) {
        ...
        this._playing && this.stop();
        var n, i, o = t(e.target || e.srcElement), r = o.closest("." + this._core.settings.itemClass), s = this._videos[r.attr("data-video")], a = s.width || "100%", l = s.height || this._core.$stage.height();
        "youtube" === s.type ? n = '<iframe width="' + a + '" height="' + l + '" src="http://www.youtube.com/embed/' + s.id + "?autoplay=1&v=" + s.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === s.type && (n = '<iframe src="http://player.vimeo.com/video/' + s.id + '?autoplay=1" width="' + a + '" height="' + l + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'),
    ...
    i.prototype.isInFullScreen = function() {
        ...
        return i && t(i).parent().hasClass("owl-video-frame") && (this._core.speed(0),
        this._fullscreen = !0),
        !(i && this._fullscreen && this._playing) && (this._fullscreen ? (this._fullscreen = !1,
...
function(t, e, n, i) {
    ...
    o.prototype.swap = function() {
        if (1 === this.core.settings.items && this.core.support3d) {
            this.core.speed(0);
            var e, n = t.proxy(this.clear, this), i = this.core.$stage.children().eq(this.previous), o = this.core.$stage.children().eq(this.next), r = this.core.settings.animateIn, s = this.core.settings.animateOut;
            this.core.current() !== this.previous && (s && (e = this.core.coordinates(this.previous) - this.core.coordinates(this.next),
            i.css({
                left: e + "px"
            }).addClass("animated owl-animated-out").addClass(s).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", n)),
            r && o.addClass("animated owl-animated-in").addClass(r).one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", n))
        }
    }
    ,
...
function(t) {
    ...
    e.prototype.draw = function() {
        var e, n, i = "", o = this._core.settings, r = (this._core.$stage.children(),
        this._core.relative(this._core.current()));
        if (!o.nav || o.loop || o.navRewind || (this._controls.$previous.toggleClass("disabled", 0 >= r),
        this._controls.$next.toggleClass("disabled", r >= this._core.maximum())),
        ...
        o.dots) {
            ...
            o.dotData && 0 !== e) {
                ...
                e > 0 ? (i = new Array(e + 1).join(this._templates[0]),
                this._controls.$indicators.append(i)) : 0 > e && this._controls.$indicators.children().slice(e).remove();
    ...
    e.prototype.getPosition = function(e) {
        ...
        return "page" == o.slideBy ? (n = t.inArray(this.current(), this._pages),
    ...
    e.prototype.to = function(e, n, i) {
        var o;
        i ? t.proxy(this._overrides.to, this._core)(e, n) : (o = this._pages.length,
        t.proxy(this._overrides.to, this._core)(this._pages[(e % o + o) % o].start, n))
    }
    ,
    ...
    e.prototype.refresh = function() {
        ...
        for (var r in t) {
            ...
            for (var a in this.waypoints[r]) {
                var l, c, u, d, h, p = this.waypoints[r][a], f = p.options.offset, g = p.triggerPoint, m = 0, v = null == g;
                ...
                i[p.group.id] = p.group) : !v && h ? (p.queueTrigger(s.forward),
                i[p.group.id] = p.group) : v && s.oldScroll >= p.triggerPoint && (p.queueTrigger(s.forward),
