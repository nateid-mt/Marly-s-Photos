    ...
    var e = {
        ...
        168: function(e, t, n) {
            ...
            !function() {
                ...
                !function() {
                    var u, s, f = window.performance || window.webkitPerformance || window.msPerformance || window.mozPerformance, d = "data-cf-beacon", l = document.currentScript || ("function" == typeof document.querySelector ? document.querySelector("script[".concat(d, "]")) : void 0), v = c(), p = [], m = window.__cfBeacon ? window.__cfBeacon : {};
                    if (!m || "single" !== m.load) {
                        if (l) {
                            ...
                            var L = m && (void 0 === m.spa || !0 === m.spa)
                              ...
                              , P = function(r) {
                                var a = function(e, t) {
                                    ...
                                    m && (1 === m.r && (c.resources = []),
                                    (0,
                                    o.sendObjectBeacon)("", c, (function() {}
                                    ), !1, C),
                                    void 0 !== m.forward && void 0 !== m.forward.url && (0,
                                    o.sendObjectBeacon)("", c, (function() {}
                                    ), !1, m.forward.url))
                                }
                                  , c = function(r) {
                                    var o, a, c, s = f.timing, d = f.memory, l = r || e(), g = {
                                        memory: {},
                                        timings: {},
                                        resources: [],
                                        tempResources: [],
                                    ...
                                    if (null == u) {
                                        if ("function" == typeof f.getEntriesByType) {
                                            ...
                                            y && Array.isArray(y) && y.length > 0 && (g.timingsV2 = {},
                                        ...
                                        M(g);
                                    if (g.firstPaint = N("first-paint"),
                                    g.firstContentfulPaint = N("first-contentful-paint"),
                                    m && (m.icTag && (g.icTag = m.icTag),
                                    g.siteToken = m.token),
                                    "function" == typeof f.getEntriesByType) {
                                        ...
                                        h.forEach((function(e) {
                                            ...
                                            T + r < 62e3 && g.tempResources ? (T += r,
                                            g.tempResources[w].push(n)) : (w++,
                                            T = 0)
                                        }
                                        ))
                                    }
                                    return JSON.stringify(g).length >= 64e3 && (g.resources = []),
                                    void 0 !== u && (delete g.timings,
                                    delete g.memory),
                                    g
                                }(r);
                                if (c && m) {
                              ...
                              , R = function() {
                                var t = function() {
                                    ...
                                    return m && (m.version && (r.versions.fl = m.version),
                                ...
                                if (n) {
                                    ...
                                    t.pushState = function(i, o, a) {
                                        ...
                                        var c = e()
                                          , s = !0;
                                        return u == c && (s = !1),
                                        s && (A() && ((null == S ? void 0 : S.url) == c && (null == S ? void 0 : S.triggered) || P(c),
                                        O(c)),
                                        r()),
                                        n.apply(t, [i, o, a])
                                    }
                                    ...
                                    window.addEventListener("popstate", (function(t) {
                                        A() && ((null == S ? void 0 : S.url) == u && (null == S ? void 0 : S.triggered) || P(u),
                                        O(u)),
                                        u = e(),
                                        r()
                                    }
        ...
        104: function(e, t) {
            !function(e) {
                ...
                var t, n, r, i, o, a = function() {
                    ...
                    t = t || {},
                    P((function() {
                        var n, r = [1800, 3e3], i = C(), o = p("FCP"), a = m("paint", (function(e) {
                            e.forEach((function(e) {
                                "first-contentful-paint" === e.name && (a.disconnect(),
                                e.startTime < i.firstHiddenTime && (o.value = Math.max(e.startTime - v(), 0),
                                o.entries.push(e),
                                n(!0)))
                            }
                            ))
                        ...
                        a && (n = g(e, o, r, t.reportAllChanges),
                        l((function(i) {
                            o = p("FCP"),
                    ...
                    r = r || {},
                    P((function() {
                        var o, a = [100, 300], c = C(), u = p("FID"), s = function(e) {
                ...
                e.onCLS = function(e, t) {
                    !function(e, t) {
                        t = t || {},
                        R(T((function() {
                            var n, r = [.1, .25], i = p("CLS", 0), o = 0, a = [], c = function(e) {
                                e.forEach((function(e) {
                                    if (!e.hadRecentInput) {
                                        var t = a[0]
                                          , n = a[a.length - 1];
                            ...
                            u && (n = g(e, i, r, t.reportAllChanges),
                            h((function() {
                                c(u.takeRecords()),
                                n(!0)
                            }
                    ...
                    !function(e, t) {
                        ...
                        P((function() {
                            ...
                            var r, i = p("INP"), o = function(e) {
                                ...
                                var t, n = (t = Math.min(J.length - 1, Math.floor(H() / 50)),
                                J[t]);
                ...
                e.onLCP = function(e, t) {
                    !function(e, t) {
                        t = t || {},
                        P((function() {
                            var n, r = [2500, 4e3], i = C(), o = p("LCP"), a = function(e) {
                                var t = e[e.length - 1];
                                if (t) {
